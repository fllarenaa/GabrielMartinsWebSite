...
<!-- Seção de contas de usuários começa -->
<section class="accounts">
   ...
   <div class="box">
      ...
      <a href="users_accounts.php?delete=<?= $fetch_accounts['id']; ?>" class="delete-btn" onclick="return confirm('Deseja realmente excluir esta conta?');">Excluir</a>
   </div>
   <?php
      }
   }else{
...
<!-- Seção de contas de usuários termina -->
